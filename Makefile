...
#CROSS_COMPILE = arm-linux-#/opt/EmbedSky/4.6.0/bin/arm-linux-
...
#	@$(MKCONFIG) $(@:_config=) arm s5pc11x TQ210 EmbedSky s5pc210
	@$(MKCONFIG) $(@:_config=) arm s5pv210 TQ210 EmbedSky s5pv210
	@echo "TEXT_BASE = 0xC3E00000" > $(obj)board/EmbedSky/TQ210/config.mk
