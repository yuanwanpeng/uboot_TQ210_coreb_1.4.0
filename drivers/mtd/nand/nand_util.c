...
int nand_erase_opts(nand_info_t *meminfo, const nand_erase_options_t *opts)
{
	...
	{
		embedsky_Write_Progress_note(LCD_BAR_START_X,LCD_BAR_START_Y+LCD_WIDE_BAR*2,LCD_BAR_LONG,1,LCD_BAR_ANNOTATE_COLOUR,"Download zImage image.");
	}
	else if (opts->flag == 1)  //logo进度条 
	{
		embedsky_Write_Progress_note(LCD_BAR_START_X,LCD_BAR_START_Y+LCD_WIDE_BAR*1,LCD_BAR_LONG,1,LCD_BAR_ANNOTATE_COLOUR,"Download logo image.");
	}
	else if (opts->flag == 3)  //bootloader进度条 
	{
		embedsky_Write_Progress_note(LCD_BAR_START_X,LCD_BAR_START_Y+LCD_WIDE_BAR*0,LCD_BAR_LONG,1,LCD_BAR_ANNOTATE_COLOUR,"Download bootloader image.");
	}
...
int nand_write_opts(nand_info_t *meminfo, const nand_write_options_t *opts)
{
	...
	if (!(meminfo->oobsize == 16 && meminfo->writesize == 512)
        ...
        && !((meminfo->oobsize == 128 || meminfo->oobsize == 218 || meminfo->oobsize == 224) && (meminfo->writesize == 4096 ))) {
	...
	else if (opts->flag == 1)  //logo进度条 
	{
		...
		embedsky_Write_Progress_note(LCD_BAR_START_X,LCD_BAR_START_Y+LCD_WIDE_BAR*1,LCD_BAR_LONG,0,LCD_BAR_ANNOTATE_COLOUR,"                            Succeeded!");
	}
	else if (opts->flag == 4)  //rootfs进度条 
	{
		...
		embedsky_Write_Progress_note(LCD_BAR_START_X,LCD_BAR_START_Y+LCD_WIDE_BAR*3,LCD_BAR_LONG,0,LCD_BAR_ANNOTATE_COLOUR,"                            Succeeded!");
	}
#endif /* CONFIG_EmbedSky_LCD */
