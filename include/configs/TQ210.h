...
#define USE_IROM		1			//是否使用iROM的Nand搬运函数
...
#define CFG_PHY_EBOOT_BASE			0x27700000
#else
...
#define CFG_STACK_SIZE						1024*1024/*512*1024*/
...
#define CFG_UBOOT_SIZE						(4*1024*1024)
...
#define CONFIG_BOOTARGS						"noinitrd ubi.mtd=3 root=ubi0:rootfs rootfstype=ubifs init=/init console=ttySAC0"
#elif defined(CONFIG_SERIAL2)
